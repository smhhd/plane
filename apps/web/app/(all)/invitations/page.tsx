    ...
    <AuthenticationWrapper>
      <div className="flex h-full flex-col gap-y-2 overflow-hidden sm:flex-row sm:gap-y-0">
        <div className="relative h-1/6 flex-shrink-0 sm:w-2/12 md:w-3/12 lg:w-1/5">
          ...
          <Link
            href="/"
            className="absolute top-1/2 start-5 z-10 grid -translate-y-1/2 place-items-center px-3 sm:top-12 sm:left-1/2 sm:-translate-x-[15px] sm:translate-y-0 sm:px-0 sm:py-5 md:start-1/3"
          >
        ...
        {invitations ? (
          invitations.length > 0 ? (
            ...
            <div className="fixed top-0 start-0 grid h-full w-full place-items-center">
              <EmptyState

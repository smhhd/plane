            ...
            >
              {image !== null || (value && value !== "") ? (
                <>
                  <button
                    type="button"
                    className="absolute top-0 end-0 z-40 translate-x-1/2 -translate-y-1/2 rounded-sm bg-surface-2 px-2 py-0.5 text-11 font-medium text-secondary"
                  >
                    Edit
                  </button>
                  <img
                    ...
                    alt="image"
                    className="absolute top-0 start-0 h-full w-full rounded-md object-cover"
                  />
                </>
              ) : (
                <div>

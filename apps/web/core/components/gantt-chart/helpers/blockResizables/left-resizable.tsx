  ...
  return (
    <>
      {(isHovering || isLeftResizing) && dateString && (
        <div className="absolute -start-36 flex h-full w-32 items-center justify-end text-11 font-regular text-tertiary">
      ...
      <div
        ...
        className="absolute top-1/2 -start-1.5 z-[6] h-full w-3 -translate-y-1/2 cursor-col-resize rounded-md"
      />
      <div
        className={cn(
          "absolute top-1/2 start-1 z-[5] h-7 w-1 -translate-y-1/2 rounded-xs bg-surface-1 opacity-0 transition-all duration-300 group-hover:opacity-100",
          {
